...
\begin{document}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item On utilise ces 6 bits sur la S-Box à attaquer. Si le résultat de la S-Box correspond à  $P^{-1}(L_{16} \oplus L_{16}^{*})$ alors on saura que les 6 bits de $K_{16}$ utilisé pour créer Ctmp et FCtmp sont une solutions possible.
