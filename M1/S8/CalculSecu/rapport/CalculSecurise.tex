...
\begin{document}
	...
	\begin{center}\includegraphics[scale=0.4]{Kderivation.png}\end{center}
	...
	\begin{center}\includegraphics[scale=0.4]{PC2graph.png}\end{center}
	On va donc facilement pouvoir reconstituer la permutation inverse $P2^{-1}$ :
	\begin{center}\includegraphics[scale=0.4]{P2inv.png}\end{center}
	...
	\begin{center}\includegraphics[scale=0.4]{P1inv.png}\end{center}
	...
	\end{itemize}
	\begin{center}\includegraphics[scale=0.4]{VerifK.png}\end{center} 
	\section{Question 4}
